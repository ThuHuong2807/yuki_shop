							...
							<?php foreach ($user as $value) { ?>
								<tr>
									...
									<td class="list_td aligncenter">
							            ...
							            <a href="../admin/user/del/<?php echo $value->id; ?>" title="delete"> <span class="glyphicon glyphicon-remove" onclick=" return confirm('Are you sure you want to delete?')"></span> </a>
								    </td>    
				                </tr>
							<?php } ?>
			    		</tbody>
