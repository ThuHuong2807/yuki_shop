		...
		<div class="panel panel-info">
			<div class="panel-body">
				...
				<div class="table-responsive">
							...
							foreach ($list_product as $value) { 
								...
								<tr>
									...
									<?php if ($transaction->status=='0') { ?>
							            ...
							            <a href="<?php echo admin_url('transaction/deldetail/'.$value->order_id) ?>" title="Xóa"> <span class="glyphicon glyphicon-remove" onclick=" return confirm('Are you sure you want to delete?')"></span> </a>
								    </td> 	
										<?php
									} ?>
					...
					<?php if ($transaction->status=='0') { ?>
						<a href="<?php echo admin_url('user/accept/'.$transaction->id); ?>" class="btn btn-success"> Order confirmation</a>	<?php
					} ?>
