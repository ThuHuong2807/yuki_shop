		...
		<div class="panel panel-info " style="margin-bottom: 15px">
		  ...
		  <div class="panel-body">
		  	...
		  	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
		  		...
		  		<?php 
		  			if ($product->discount > 0) {
		  				...
		  				?><p>Old price: <strong><del><?php echo number_format($product->price) ?> VNĐ</del></strong></p>
		  				<p>Discount: <span style="font-weight: bold;color: green"><?php echo number_format($price_new); ?> VNĐ</span></p>
		  			<?php }else{ ?>
		  				<p>Price: <span style="font-weight: bold;color: green"><?php echo number_format($product->price); ?> VNĐ</span></p> <?php
		  			} 
		  		?>
		  	...
		  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
		  		...
		  		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		  			<img src="<?php echo base_url(); ?>upload/icon/services.png" alt="">
		  			<p style="color:red">Exchange within 24 hours</p>
		  		</div>
		  	</div>
		  </div>
		</div>
